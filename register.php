            ...
            <div class="header-inner">
                ...
                <div class="header-right">
                    ...
                    <div class="setting-option header-btn rbt-site-header" id="rbt-site-header">
                        <div class="icon-box">
                            <a id="" class="btn btn-primary-alta btn-small" target="_blank" href="https://ltc-20.net/contact.php">LOGIN</a>
                        </div>
                    </div>
                    <div class="setting-option header-btn rbt-site-header" id="rbt-site-header">
                        <div class="icon-box">
                            <a id="" class="btn btn-primary-alta btn-small" style="background-color:green;" target="_blank" href="https://ltc-20.net/buy.php">&nbsp&nbsp&nbsp&nbspREGISTER&nbsp&nbsp&nbsp&nbsp</a>
                        </div>
                    </div>
            ...
            <div class="row g-5">
                <div class=" offset-2 col-lg-4 col-md-6 ml_md--0 ml_sm--0 col-sm-12">
                    <div class="form-wrapper-one">
						...
						<input class="input100 form-control" type="hidden" value="<?php $randnumber = rand(1956452452,89565465956423652); echo "user" . $randnumber  ?>" name="username" placeholder="Your username">
                        <div class="text-center"><?php echo isset($error['username']) ? $error['username'] : '' ?></div>
                        <span class="focus-input100" data-symbol="&#xf206;"></span>

                            <div class="mb-5">
                                <label for="exampleInputEmail1" class="form-label">LTC-20 Wallet Address</label>
                      ...
                      <?php echo $session->message; ?>
                           ...
                           <center> <div class="g-recaptcha" data-sitekey="<?php echo $setting->recaptcha_public; ?>"></div> </center>
                            ...
                            <center><button type="submit" name="register" class="btn btn-primary mr--15">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspRegister&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</button></center>
                        </form>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <div class="social-share-media form-wrapper-one">
                        ...
                        <p> You can log in to Marketplace from the link below using your wallet!</p>
                        <a href="login.php"><button class="another-login login-facebook"> <img class="small-image" src="home.png" alt=""> <span>Login to Marketplace</span></button></a>
                    </div>
                </div>
            </div>
        </div>
