...
if(isset($_POST['register'])) {
   ...
   if(isset($_POST['g-recaptcha-response']) && !empty($_POST['g-recaptcha-response'])) {
    ...
    if($email == '') {
        $error['email'] = "<div class='alert alert-warning' role='alert'>Wallet field cannot be empty!</div>";
    }
    
    $check_email = Users::email_exists($email);
    
    if($check_email == true) {
        $error['email'] = "<div class='alert alert-warning' role='alert'>Wallet already exists!</div>";
    }
        ...
        if($r != '' || !empty($r)) {
            ...
            if($ref_exists) {
                ...
                if($register_user == true) {
					...
					$session->message = "<div class='alert alert-primary' role='alert'>Your account was registered, You are being redirected to Login ..</div>";
