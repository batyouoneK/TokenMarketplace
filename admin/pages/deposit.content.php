									...
									<p>Click on <strong>PENDING</strong> button to change payment request status to <strong>COMPLETED</strong>.</p>
											   <div class="table-responsive">
												...
												<?php  while ($satir = $kayit->fetch_assoc()) { ?>
														...
														<td>
														<span><a href="<?php echo $satir["linki"];?>"> <button class="btn btn-success btn-sm" name="pay">Check Status</button></a></span>
														</td>	
												...
												if(isset($_POST["testie"])){
													...
													$sqlquery = "UPDATE users SET balance=$newbalans WHERE id=$usern";
