            ...
            <div class="card-body card-block">
                ...
                <div class="row form-group">
                    <div class="col col-md-3">
                        <label for="hf-name" class=" form-control-label">Wallet</label>
                    </div>
                ...
                <div class="row form-group">
                    <div class="col col-md-3">
                        <label for="hf-profit" class=" form-control-label">LTST Amount</label>
                    </div>
                    <div class="col-12 col-md-9">
                ...
                <div class="row form-group">
                    <div class="col col-md-3">
                        <label for="hf-duration" class=" form-control-label">Seller User ID</label>
                    </div>
                    <div class="col-12 col-md-9">
