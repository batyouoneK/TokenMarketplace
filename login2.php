                                    ...
                                    <div class="rn-product-inner">
                                        <ul class="product-list">
                                            <li class="single-product-list">
                                                <div class="thumbnail">
                                                    <a href="product-details.html"><img src="https://rainbowit.net/html/nuron/assets/images/portfolio/portfolio-07.jpg" alt="Nft Product Images"></a>
                                                </div>
                                                <div class="content">
            ...
            <div class="row g-5">
                    ...
                    <div class="form-wrapper-one">
                        ...
                        <form action="" method="post">
                           ...
                           <center> <div class="g-recaptcha" data-sitekey="<?php echo $setting->recaptcha_public; ?>"></div> </center>
                            ...
                            <button type="submit" name="login" class="btn btn-primary mr--15">Log In</button>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <div class="social-share-media form-wrapper-one">
                        ...
                        <button class="another-login login-facebook"> <img class="small-image" src="https://rainbowit.net/html/nuron/assets/images/icons/google.png" alt=""> <span>Log in with Google</span></button>
                        <button class="another-login login-facebook"> <img class="small-image" src="https://rainbowit.net/html/nuron/assets/images/icons/facebook.png" alt=""> <span>Log in with Facebook</span></button>
                        <button class="another-login login-twitter"> <img class="small-image" src="https://rainbowit.net/html/nuron/assets/images/icons/tweeter.png" alt=""> <span>Log in with Twitter</span></button>
                        <button class="another-login login-linkedin"> <img class="small-image" src="https://rainbowit.net/html/nuron/assets/images/icons/linkedin.png" alt=""> <span>Log in with linkedin</span></button>
                    </div>
                </div>
            </div>
        </div>
