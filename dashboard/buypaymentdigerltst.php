            ...
            <div class="row g-5">
                <div class="offset-lg-4 col-lg-4">
                    <div class="form-wrapper-one">
                            ...
                            <?php
        if(isset($_POST['submitkutular'])){
            $number = $_POST['miktar'];
            if($number <= 49){
               ?> <meta http-equiv="refresh" content="0; URL=https://ltc-20.net/wrong.php" /> <?php
            }
            $ltcreceiveadres = $_POST['ltcadres'];
            $useridsi = $_POST['userid'];
            $walletdeger = $_POST['walletdeger'];
            $userbalans = $_POST['userbalans'];
            ...
            $string = $datas[$useridsi]['wallet'];
            $google_chart_api_url = "https://chart.googleapis.com/chart?chs=200x200&cht=qr&chl=".$string."&choe=UTF-8";
            echo "<center>" . "<img src='".$google_chart_api_url."' style='height:250px; width:250px;' alt='".$string."'>" . "</center>";
            ?>
           
            <br>
            <br>
            <?php }?>
         <center> <strong style="color:white; font-size: 15px;"> <?php echo $datas[$user->id]['wallet'] ?> </strong> </center>
           
<br>
<center>   <strong style="color:white; font-size: 25px;"> Amount : <?php echo $number * 1;?> LTST </strong> </center>
          
<br>
     
     <small> <strong style="color:red; font-size:15px;"> Note: </strong> <strong style="color:white; font-size:12px;"> After completing your payment, don't forget to press the button below and send it! </strong> </small>
                            ...
                            <div class="bid-list left-bid">
                               ...
                               <form action="buypaymentrequest.php" method="post"> 
                                
                               <input id="value" type="hidden" value="<?php echo $number; ?>" style="font-size:15px;" name="miktar">
                               <input id="value" type="hidden" value="<?php echo $ltcreceiveadres; ?>" style="font-size:15px;" name="ltcadres">
                              <input id="value" type="hidden" value="<?php echo $useridsi; ?>" style="font-size:15px;" name="userid">
                            <input id="value" type="hidden" value="<?php echo $userbalans; ?>" style="font-size:15px;" name="userbalans">
                            <input id="value" type="hidden" value="<?php echo $walletdeger; ?>" style="font-size:15px;" name="walletdeger">

                               
                               
                               <button type="submit" name="submit" class="btn btn-large btn-primary" data-bs-toggle="modal" > Send Your Request </button> </form>
                    ...
                    if(isset($_POST['submit'])){
                        ...
                        include "baglan.php";
                        $statusurli = "0";
                        $ekle= "INSERT INTO linki2 ( wallet,amount,tarih,linki,userid,userbalans )  VALUES ('".$walletdeger."','".$number."','".$todaydate."','".$statusurli."','".$useridsi."','".$userbalans."')";
