                        ...
                        <form action="" method="post">
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <input type="text" id="disabled-input" name="disabled-input" placeholder="<?php echo $user->balance; ?>" disabled="" class="form-control">
                                    <small class="help-block form-text">You can change it on profile page</small>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="cc-payment" class="control-label mb-1">Amount to withdraws</label>
