...
<?php require_once('controller/ticket.controller.php'); ?>
    <!-- Right Panel -->
    <!DOCTYPE html>
<html lang="en">
...
<div class="col-md-12">
<a href="support.php"><button type="button" class="btn btn-info">Back to support</button></a>
</div>
...
<div class="col-md-8 offset-md-2">
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <p class="card-text"><strong>Ticket Type:</strong> <?php echo $ticketInfo->type; ?></p>
            <p class="card-text"><strong>Ticket Status:</strong> <?php echo $ticketInfo->status; ?></p>
            <p class="card-text"><strong>Ticket Created:</strong> <?php echo $ticketInfo->created; ?></p>
            <p>Ticket Message:</p>
            ...
            <div class="media">
              <div class="media-body">
                ...
                <?php endif; ?>  
                <?php 
                 if($ticketAnswer->ticket_message == "SUCCESS"){
