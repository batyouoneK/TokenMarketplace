            ...
            <div class="row g-5">
                <div class="offset-lg-4 col-lg-4">
                    <div class="form-wrapper-one">
                        ...
                        <form action="buypaymentdiger.php" method="post">
                        <div class="mb-5">
                         <center><strong><label for="exampleInputEmail1" style="font-size:25px; color:white;" class="form-label">DEPOSIT LTC</label></strong></center>
                         <br>
                            <input id="value" class="bmi_input" id="txtAd" name="miktar" type="float" min="0.1" max="15" placeholder="Enter LTC amount">
                        </div>
                        ...
                        <input id="value" type="hidden" value="<?php echo $user->balance; ?>" style="font-size:15px;" name="userbalans">
