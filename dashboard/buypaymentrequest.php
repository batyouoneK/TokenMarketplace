            ...
            <div class="row g-5">
                <div class="offset-lg-4 col-lg-4">
                  ...
                  ?>
                            ...
                            <center> <img style="height:50%; width:50%;" src="verified.png"></center>
                                <center> <h6 class="title">Your request has been sent successfully!</h6></center>
                                <center>   <small> <strong style="color:red; font-size:15px;"> Note: </strong> <strong style="color:white; font-size:12px;"> Your balance will be credited to your account within 12 hours after the checks are provided . </strong> </small></center>
                                <?php
                  
                  }
                  ?>
                                <center><a href="index.php">  <button type="button" class="btn btn-large btn-primary" data-bs-toggle="modal" > GO MARKETPLACE </button></a> </center>
                            </div>
                        </div>
