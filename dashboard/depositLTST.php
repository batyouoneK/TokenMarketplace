...
?>
                        ...
                        <form action="buypaymentdigerltst.php" method="post">
                        <div class="mb-5">
                         <center><strong><label for="exampleInputEmail1" style="font-size:25px; color:white;" class="form-label">DEPOSIT LTST</label></strong></center>
                         <br>
                            <input id="value" class="bmi_input" id="txtAd" name="miktar" type="float" min="0.1" max="15" placeholder="Enter LTST amount">
                        </div>
                        <input id="value" type="hidden" value="<?php echo $user->email; ?>" style="font-size:15px;" name="ltcadres">
                        <input id="value" type="hidden" value="<?php echo $user->id; ?>" style="font-size:15px;" name="userid">
                        <input id="value" type="hidden" value="<?php if(!$profitperday) {echo 0;} else { echo $profitperday->profit*1; } ?> " style="font-size:15px;" name="userbalans">
                        <input id="value" type="hidden" value="<?php echo $datas[$user->id]['wallet']; ?>" style="font-size:15px;" name="walletdeger">
                       

                        <div class="mb-5">
                           <center> <button name="submitkutular" type="submit" class="btn btn-large btn-primary">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspDEPOSIT&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</button></center>
                        </div>
