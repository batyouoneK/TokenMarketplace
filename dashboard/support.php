		...
		<div class="contact-box">
			...
			<div class="right">
                ...
                <form action="" method="post" class="form-horizontal">
                    ...
                    <div class="row form-group">
                        <div class="col col-md-3"> 
                            <label for="title" class=" form-control-label">Username&nbsp&nbsp&nbsp&nbsp</label>
                        </div>
                        <div class="col-12 col-md-9">
                            <input type="text" name="title" placeholder="Your Username" class="form-control">
                        </div>
                    </div>
    ...
    <div class="col-md-12">
        ...
        <div class="card">
            <div class="card-header">
             <center>   <strong class="card-title" style="font-size:30px;">My latest 10 tickets</strong> </center>
            </div>
        <div class="table-stats order-table ov-h" >
            <table class="table ">
                <thead>
                    <tr >
                        <th style="background-color:#3258ca; color:white; font-size:15px; ">Type</th>
                        <th style="background-color:#3258ca; color:white; font-size:15px;">Title</th>
                        <th style="background-color:#3258ca; color:white; font-size:15px;">Created</th>
                        <th style="background-color:#3258ca; color:white; font-size:15px;">Status</th>
                        <th style="background-color:#3258ca; color:white; font-size:15px;"></th>
                        <th style="background-color:#3258ca; color:white; font-size:15px;"></th>
                      ...
                      ?>
                        ...
                        <tr>
                            ...
                            <?php if($ticket->status == 'pending'):?>
                                <button class="btn btn-warning" style="background-color:#f6c23e
;">Pending</button>
                            <?php else: ?>
                            ...
                            <td>
                                <form action="" method="post">
                                    ...
                                    <button type="submit" name="delete" class="btn btn-danger" style="background-color:#e74a3b
;">Remove</button>
                                </form>
                            </td>
						</tr>
