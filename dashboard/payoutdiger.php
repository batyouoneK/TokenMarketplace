...
<?php require_once('controller/payout.controller.php'); ?>
...
<body class="template-color-1 nft-body-connect">
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6 col-md-6 col-12">
                 <center>   <h5 class="title text-center text-md-start">WITHDRAW YOUR BALANCE</h5> </center>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row g-5">
                <div class="offset-lg-4 col-lg-4">
                    <div class="form-wrapper-one">
                            ...
                            <center><strong><label for="exampleInputEmail1" style="font-size:25px; color:white;" class="form-label">WITHDRAW BALANCE</label></strong></center>
                         <br>
                        <div class="row form-group">
                        <div class="icon-box">
                            <a id="" class="btn btn-primary-alta btn-small" target="_blank" href="login.php">LTST Balance :<span class="value" style="color:#1DFB19"> <?php if(!$profitperday) {echo 0;} else { echo $profitperday->profit*1; } ?> LTST</span></a>
                        </div>
                        
                        <div class="icon-box">
                            <a id="" class="btn btn-primary-alta btn-small" target="_blank" href="login.php">LTC Balance &nbsp: <span class="value" style="color:#1BD5E6"> <?php echo $user->balance * 1 ; ?> LTC&nbsp&nbsp</span></a>
                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <small style="font-size:13px;" class="help-block form-text">You can change it on profile page</small>
                                </div>
                        </div>
                        <div class="half-wid currency">
                                        <!-- select gender -->
                                        <label for="cc-payment" class="control-label mb-1">Withdraw Currency</label>
                                        <select required name="secim" class="profile-edit-select">
                                            <option selected value="1">Litecoin</option>
                                            <option value="2">LTST</option>
                                        </select>
                                        <!-- end gender -->
                                    </div>
                        <div class="form-group">
                            <label for="cc-payment" class="control-label mb-1">Amount to withdraw</label>
                            <input name="amount" type="text" class="form-control" required aria-required="true" aria-invalid="false" value="100">
                        </div>

                        <div>
                        <center> <button id="payment-button" type="submit" class="btn btn-lg btn-info btn-block" name="request">
                            <i class="fa fa-lock fa-lg"></i>&nbsp;
                            <span id="payment-button-amount">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspWITHDRAW&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp  <i class="fa fa-lock fa-lg"></i></span>
                        </button></center>
                        </div>
                    </form>
    ...
    <div class="box-table table-responsive">
                  ...
                  ?>
                        ...
                        <td><span><?php echo $withdrawal->date; ?></span></td>
                        <td><span><?php echo $withdrawal->address; ?> </span></td>
                        <td><span><?php echo $withdrawal->amount * 1; ?>  </span></td>
                        <td><span>
